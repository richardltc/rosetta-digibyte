...
import (
	...
	digibyte "github.com/tehG30RG3/rosetta-digibyte/digibyte"
...
func (_m *Client) GetRawBlock(_a0 context.Context, _a1 *types.PartialBlockIdentifier) (*digibyte.Block, []string, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *digibyte.Block
	if rf, ok := ret.Get(0).(func(context.Context, *types.PartialBlockIdentifier) *digibyte.Block); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*digibyte.Block)
		}
	}
...
func (_m *Client) ParseBlock(_a0 context.Context, _a1 *digibyte.Block, _a2 map[string]*storage.AccountCoin) (*types.Block, error) {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 *types.Block
	if rf, ok := ret.Get(0).(func(context.Context, *digibyte.Block, map[string]*storage.AccountCoin) *types.Block); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *digibyte.Block, map[string]*storage.AccountCoin) error); ok {
		r1 = rf(_a0, _a1, _a2)
	} else {
		r1 = ret.Error(1)
	}
