...
func (_m *Indexer) GetScriptPubKeys(_a0 context.Context, _a1 []*types.Coin) ([]*digibyte.ScriptPubKey, error) {
	ret := _m.Called(_a0, _a1)

	var r0 []*digibyte.ScriptPubKey
	if rf, ok := ret.Get(0).(func(context.Context, []*types.Coin) []*digibyte.ScriptPubKey); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*digibyte.ScriptPubKey)
		}
	}
