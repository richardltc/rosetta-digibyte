...
func TestConstructionService(t *testing.T) {
	...
	assert.Equal(t, &types.ConstructionDeriveResponse{
		AccountIdentifier: &types.AccountIdentifier{
			Address: "dgbt1qcqzmqzkswhfshzd8kedhmtvgnxax48z4pp2yjt",
		},
	}, deriveResponse)
	...
	ops := []*types.Operation{
		...
		},
		{
			...
			Account: &types.AccountIdentifier{
				Address: "dgbt1q3r8xjf0c2yazxnq9ey3wayelygfjxpfq6m88jw",
			},
			Amount: &types.Amount{
				Value:    "954843",
				Currency: digibyte.TestnetCurrency,
		...
		},
		{
			...
			Type: digibyte.OutputOpType,
			Account: &types.AccountIdentifier{
				Address: "dgbt1qjsrjvk2ug872pdypp33fjxke62y7awpg37kfzd",
			},
			Amount: &types.Amount{
				Value:    "44657",
				Currency: digibyte.TestnetCurrency,
		...
		ScriptPubKeys: []*digibyte.ScriptPubKey{
			{
				...
				Addresses: []string{
					"dgbt1qcqzmqzkswhfshzd8kedhmtvgnxax48z4pp2yjt",
				},
			},
		},
	}
	...
	// Test Payloads
	unsignedRaw := "" // nolint
