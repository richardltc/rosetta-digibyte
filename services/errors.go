...
var (
	...
	// ErrNotReady is returned when digibyted is not
	// yet ready to serve queries.
	ErrNotReady = &types.Error{
		Code:      2, //nolint
		Message:   "DigiByted is not ready",
		Retriable: true,
	}

	// ErrDigiByted is returned when digibyted
	// errors on a request.
	ErrDigiByted = &types.Error{
		Code:    3, //nolint
		Message: "DigiByted error",
	}
	...
	// digibyte.ScriptPubKeys to construct a transaction.
	...
	// digibyte.ScriptPubKey cannot be parsed during construction.
