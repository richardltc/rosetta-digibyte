...
usage() {
  this=$1
  cat <<EOF
$this: download pre-compiled Docker images for tehG30RG3/rosetta-digibyte 
...
execute() {
  ...
  docker tag "rosetta-digibyte:${TAG}" "rosetta-digibyte:latest"
  log_info "loaded rosetta-digibyte:${TAG} and tagged as rosetta-digibyte:latest"
  rm -rf "${tmpdir}"
...
BINARY=rosetta-digibyte
FORMAT=tar.gz
OWNER=coinbase
REPO="rosetta-digibyte"
PREFIX="$OWNER/$REPO"
